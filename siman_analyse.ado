...
*  version 0.8      08may2024    IW no longer remove any underscores
*  version 0.7      03apr2024    IW make it work with missing se()
...
*  version 0.5      11jul2022    EMZ changing created variable names to start with _, and adding error catching messages
*  version 0.4      16may2022    EMZ minor bug fix with renaming of mcse's
*  version 0.3      28feb2022    Changes from IW testing
*  version 0.2      23jun2020    IW change: added in notable option
*  version 0.1      08jun2020    Ella Marley-Zagar, MRC Clinical Trials Unit at UCL
* File to analyse simulation study and return estimated performance
