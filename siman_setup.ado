...
*   version 0.10     07may2024   IW major restructure
...
*   version 0.8.0    04jul2023   EMZ: true has to be numeric only
*   version 0.7.9    26jun2023   EMZ added methodcreated characteristic
*   version 0.7.8    06jun2023   EMZ bug fix: numeric target with string labels not displayed in siman describe table (displayed numbers not values)
...
*   version 0.7.5    21mar2023   EMZ bug fix: dataset variables not in siman setup
*   version 0.7.4    06mar2023   EMZ added conditions to check dataset for additional variables not included in siman setup syntax
*   version 0.7.3    02mar2023   EMZ bug fixes
...
*   version 0.5      11jul2022   EMZ changes to error catching.
